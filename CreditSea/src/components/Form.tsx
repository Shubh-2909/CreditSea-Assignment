      ...
      <div className="grid grid-rows-[1fr_8fr_1fr] bg-white h-5/6 lg:w-3/4 w-full">
        ...
        <div className="grid grid-cols-2">
          <div className="flex flex-col items-center justify-evenly pt-2">
            <label
              className="w-5/6 text-black font-semibold sm:text-xl text-sm p-1 cursor-pointer"
              htmlFor="name"
            >
            ...
            <input
              type="text"
              className="bg-white w-5/6 md:h-14 h-12 rounded-lg p-2 font-normal md:font-semibold outline-none border-2 border-slate-300"
            ...
            <textarea
              className="bg-white w-5/6 md:h-28 h-24 rounded-lg p-2 font-normal md:font-semibold outline-none border-2 border-slate-300"
              id="reason"
        ...
        <div className="flex justify-center items-center">
          <button
            className="bg-green-200 w-28 sm:h-12 h-10 rounded-lg font-extrabold hover:bg-green-400 border shadow transition-all duration-300 ease-in"
            onClick={handleForm}
          >
            Submit
          </button>
